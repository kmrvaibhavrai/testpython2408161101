            ...
            {showAuthMessage ? (
                <Stack className={styles.chatEmptyState}>
                    ...
                    <h2 className={styles.chatEmptyStateSubtitle}>
                        This app askdljaslkdjlaskjdlkajs does not have authentication configured. Please add an identity provider by finding your app in the 
                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Start chatting - Vinay</h1>
